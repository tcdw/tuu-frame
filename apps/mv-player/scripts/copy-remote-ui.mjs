...
async function copyRemoteUiAssets() {
  try {
    ...
    if (sourceExists) {
      ...
      console.warn(`SCRIPT_LOG: Warning: Source directory ${remoteUiDist} does not exist. Skipping copy. This might be expected if 'mv-remote-ui' has not been built yet.`);
    }
  } catch (error) {
